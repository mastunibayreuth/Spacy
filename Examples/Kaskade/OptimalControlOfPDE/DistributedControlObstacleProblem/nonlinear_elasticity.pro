...
LIBS += -L/opt/lib_extern_kaskade/gcc-5.4.0/boost-1.59.0/lib -Wl,-rpath, /opt/lib_extern_kaskade/gcc-5.4.0/boost-1.59.0/lib -lboost_signals -lboost_program_options -lboost_system -lboost_timer -lboost_thread -lboost_chrono -lpthread
