...
public:
	...
	{
        std::cout << "Warning: This method paramUdape should not be called!! " << '\n';
    return;
	}
	...
	public:
        ...
        BoundaryCache(NonlinearElasticityFunctionalDistributed const& f,
				typename AnsatzVars::VariableSet const& vars_, int flags = 7) :
                vars(vars_),
                beta{0.0,0.0,0.0},
                up
...
//				alpha = 0.0;
	...
	explicit NonlinearElasticityFunctionalDistributed(Integrand f, const ControlVarSet & controlVar) :
            f_(std::move(f)), controlVar_(controlVar)
	{
